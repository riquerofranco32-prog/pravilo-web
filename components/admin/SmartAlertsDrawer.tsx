                      ...
                      <div className="mt-3 flex items-center gap-2">
                        {b.customerPhone && (
                          <a
                            ...
                            className="flex-1 text-center py-2 px-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-black text-xs font-condensed font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all shadow"
                          >
